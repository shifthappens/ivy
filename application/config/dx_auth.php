...
$config['DX_website_name'] = 'Agriwerker';
$config['DX_webmaster_email'] = 'info@agriwerker.nl';
...
$config['DX_deny_uri'] = "/" . lang('home/deny') . "/";
$config['DX_login_uri'] = "/" . lang('home/login') . "/";
$config['DX_banned_uri'] = "/" . lang('home/banned') . "/";
$config['DX_activate_uri'] = "/" . lang('home/activate') . "/";
$config['DX_reset_password_uri'] = "/" . lang('home/reset_password') . "/";
...
// URI Locations
$config['DX_logout_uri'] = lang('/home/logout');
$config['DX_register_uri'] = lang('register');
$config['DX_forgot_password_uri'] = lang('home/forgot_password') . "/";
$config['DX_change_password_uri'] = lang('/home/change_password') . "/";
$config['DX_cancel_account_uri'] = lang('/profile/farewell') . "/";

// Forms view
$config['DX_login_view'] = 'login_content';
